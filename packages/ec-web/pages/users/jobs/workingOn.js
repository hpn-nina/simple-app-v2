...
import JobCard from '../../../components/WorkingOnCard';
    ...
    if(!props.transactionsData || props.transactionsData === undefined) {
        return (
            <div className='container'>
                <div className='title'>Công việc bạn đang nhận</div>
                <div className='italic center'>Tik tok tik tok, thời gian hết hạn sắp đến rồi, hãy làm việc ngay đi nhé</div>
...
export const getServerSideProps = async({req, res}) => {
    ...
    const transactionsData = await fetch(`${process.env.API_URL}/transactions?freelancer._id=${session.id}&transactionStatus=WorkingOn`,{
        method: "GET",
        headers: {
